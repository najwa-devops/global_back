...
/**
 * Teste la logique de décision du moteur OCR dans SalesInvoiceProcessingService.
 *
 ...
 */
class OcrEngineSelectionTest {

    /**
     * Reproduit exactement la condition de SalesInvoiceProcessingService.
