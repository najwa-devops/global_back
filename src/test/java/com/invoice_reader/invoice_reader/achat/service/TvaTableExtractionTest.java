...
class TvaTableExtractionTest {
    ...
    private AchatFieldExtractorService extractor;

    @BeforeEach
    void setUp() {
        extractor = new AchatFieldExtractorService(textCleaningService);
    }
    ...
    void testExtractHtFromTvaTable_SOREMED_Format() {
        ...
        try {
            java.lang.reflect.Method method = AchatFieldExtractorService.class
