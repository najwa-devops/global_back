...
class AchatFieldExtractorServiceTest {

    @Mock
    private TextCleaningService textCleaningService;

    private AchatFieldExtractorService extractorService;

    @org.junit.jupiter.api.BeforeEach
    void setUp() {
        extractorService = new AchatFieldExtractorService(textCleaningService);
    }
    ...
    void extractWithoutTemplate_givenUserRegexLabels_whenExtract_thenFindExpectedValues() {
        ...
        AchatExtractionResult result = extractorService.extractWithoutTemplate(ocr);
