package com.invoice_reader.invoice_reader.liaison_rlv_b_ctr_mntq.controller;
...
public class CentreMonetiqueLiaisonController {
    ...
    public ResponseEntity<?> cmExpansionsForStatement(
        ...
        try {
            ...
            if (resolvedDossierId == null && sessionUser.isClient()) {
                Optional<BankStatement> stmtForFallback = bankStatementRepository.findById(statementId);
            ...
            Optional<BankStatement> statementOpt = bankStatementRepository.findById(statementId);
