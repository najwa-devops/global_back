...
@Slf4j
@CrossOrigin(origins = "*")
public class BankStatementAccountingController {
    ...
    public ResponseEntity<?> simulate(
        ...
        try {
            ...
            BankStatement statement = requireStatementForUser(id, dossierId, sessionUser, session);
            if (statement == null) {
    ...
    private BankStatement requireStatementForUser(
            Long statementId,
