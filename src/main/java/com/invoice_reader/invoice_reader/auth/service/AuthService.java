...
public class AuthService {
    ...
    public SessionUser requireSessionUser(HttpSession session) {
        ...
        Long idValue;
        com.invoice_reader.invoice_reader.database.entity.auth.UserRole roleValue;
        try {
            idValue = userId instanceof Long ? (Long) userId : Long.valueOf(userId.toString());
            roleValue = com.invoice_reader.invoice_reader.database.entity.auth.UserRole.valueOf(role.toString());
