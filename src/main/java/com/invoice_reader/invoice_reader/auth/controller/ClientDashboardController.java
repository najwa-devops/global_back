...
public class ClientDashboardController {
    ...
    public ResponseEntity<?> listBankStatements(
        ...
        List<BanqueReleve> statements = bankStatementRepository.findByDossierIdOrderByCreatedAtDesc(resolvedDossierId);
    ...
    private boolean isPendingSalesInvoice(VenteInvoice invoice) {
        if (invoice == null || invoice.getStatus() == null) {
            return false;
        }
        return switch (invoice.getStatus()) {
    ...
    private Map<String, Object> invoiceToMap(AchatInvoice invoice) {
    ...
    private Map<String, Object> salesInvoiceToMap(VenteInvoice invoice) {
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("id", invoice.getId());
        map.put("filename", invoice.getFilename());
        map.put("originalName", invoice.getOriginalName());
    ...
    private Map<String, Object> bankStatementToMap(BanqueReleve statement) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    private Object getFieldValue(AchatInvoice invoice, String fieldName) {
