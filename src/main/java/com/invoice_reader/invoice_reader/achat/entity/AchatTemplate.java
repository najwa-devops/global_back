...
public class AchatTemplate {
    ...
    private List<AchatFieldDefinitionJson> fieldDefinitions;
    ...
    @AllArgsConstructor
    @Builder
    public static class AchatFieldDefinitionJson {
    ...
    public AchatFieldDefinitionJson getFieldDefinition(String fieldName) {
    ...
    public List<AchatFieldDefinitionJson> getRequiredFields() {
    ...
    public List<String> getFieldNames() {
        if (fieldDefinitions == null) return new ArrayList<>();
        return fieldDefinitions.stream()
            .map(AchatFieldDefinitionJson::getFieldName)
            .toList();
    }
