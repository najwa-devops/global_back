...
/**
 * DTO pour AchatTemplate (réponse API)
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class AchatTemplateDto {
     ...
     */
    public static AchatTemplateDto fromEntity(AchatTemplate entity) {
        if (entity == null) return null;

        AchatTemplateDtoBuilder builder = AchatTemplateDto.builder()
            .id(entity.getId())
        ...
        if (entity.getFixedSupplierData() != null) {
            AchatTemplate.FixedSupplierData fsd = entity.getFixedSupplierData();
