...
/**
 * Entité VenteInvoice (Facture de Vente)
 * Copie exacte de AchatInvoice — table: sales_invoice
 * Règle métier: ICE pris depuis le HEADER (premier ICE détecté)
 */
@Entity
@Data
