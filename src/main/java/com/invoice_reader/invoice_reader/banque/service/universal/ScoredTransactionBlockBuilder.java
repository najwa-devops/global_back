...
public class ScoredTransactionBlockBuilder implements TransactionBlockBuilder {
    ...
    public ScoredTransactionBlockBuilder(BanqueLayoutProfileRegistry profileRegistry) {
    ...
    public List<TransactionBlock> buildBlocks(String text, TransactionExtractionContext context) {
        ...
        BanqueType bankType = context.bankType() != null ? context.bankType() : BanqueType.UNKNOWN;
    ...
    private boolean isTransactionStartLine(String line, BanqueType bankType) {
        ...
        if (bankType == BanqueType.UNKNOWN) {
