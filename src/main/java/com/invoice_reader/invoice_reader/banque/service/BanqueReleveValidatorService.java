...
public class BanqueReleveValidatorService {
     ...
     */
    public ValidationResult validateBalances(BanqueReleve statement) {
     ...
     */
    public ContinuityResult checkContinuity(BanqueReleve statement) {
        ...
        Optional<BanqueReleve> previousOpt = findPreviousMonth(statement);
        ...
        BanqueReleve previous = previousOpt.get();
     ...
     */
    private Optional<BanqueReleve> findPreviousMonth(BanqueReleve statement) {
        ...
        List<BanqueReleve> candidates = repository.findAllByRibAndYearAndMonthOrderByCreatedAtDescIdDesc(
                statement.getRib(),
                prevYear,
                prevMonth);
     ...
     */
    public FullValidationResult validateFully(BanqueReleve statement) {
