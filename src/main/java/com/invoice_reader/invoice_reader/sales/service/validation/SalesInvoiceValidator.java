...
public class SalesInvoiceValidator {
     ...
     * details.
     */
    public SalesInvoiceStatus determineStatus(SalesExtractionContext ctx, String ocrText) {
        if (ocrText == null || ocrText.trim().isEmpty()) {
            return SalesInvoiceStatus.ERROR;
        }
        ...
        return SalesInvoiceStatus.EXTRACTED;
    }
     ...
     */
    public List<String> detectLowConfidenceFields(SalesExtractionContext ctx) {
